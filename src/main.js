  ...
  return `<section class="card">
    ...
    <fieldset class="mt-6 border-t border-slate-200 pt-5">
      ...
      <div class="mt-3 grid gap-3 sm:grid-cols-2">
        <label class="mode-choice ${lastPlaceMode === "fair" ? "is-selected" : ""} p-4"><span class="flex items-start gap-3"><input class="mt-1" type="radio" name="last-place-mode" value="fair" ${lastPlaceMode === "fair" ? "checked" : ""}><span><strong class="block">Fair playoff</strong><span class="mode-choice-description mt-1 block text-sm">Players eliminated without a real win enter an automatic loser event. Byes do not count as wins.</span></span></span></label>
        <label class="mode-choice ${lastPlaceMode === "standard" ? "is-selected" : ""} p-4"><span class="flex items-start gap-3"><input class="mt-1" type="radio" name="last-place-mode" value="standard" ${lastPlaceMode === "standard" ? "checked" : ""}><span><strong class="block">Standard placement</strong><span class="mode-choice-description mt-1 block text-sm">Use only the normal double-elimination standings with no separate loser playoff.</span></span></span></label>
      </div>
    </fieldset>
